...
type IUserRepository interface {
	...
	Update(ctx context.Context, request *dto.UpdateRequest, string2 string) (*models.User, error)
	FindByUsername(ctx context.Context, string2 string) (*models.User, error)
	FindByEmail(ctx context.Context, string2 string) (*models.User, error)
	FindByUUID(ctx context.Context, string2 string) (*models.User, error)
}
